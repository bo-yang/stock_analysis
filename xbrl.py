...
from stock_analysis.xbrl_fundamentals import FundamentantalAccountingConcepts
...
class XBRL:
    def __init__(self,XBRLInstanceLocation):
        ...
        self.oInstance = etree.fromstring(self.EntireInstanceDocument.encode('ascii', 'ignore'))
        self.ns = {}
